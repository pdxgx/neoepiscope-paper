...
## srun --partition=exacloud --time=1-12:00:00 --exclusive

## Run script w/ taskset:
## taskset -c 0,1,2,3 ./benchmark_nogermline_neoepiscope.sh {HOME_DIR} {TUMOR_SAMPLE_ID} {NORMAL_SAMPLE_ID} {HLA_ALLELES}
...
OUTPUT=${HOME_DIR}/${TUMOR_SAMPLE_ID}_v_${NORMAL_SAMPLE_ID}.neoepiscope.tumor.out
TIMELOG=${HOME_DIR}/${TUMOR_SAMPLE_ID}_v_${NORMAL_SAMPLE_ID}.neoepiscope.tumor.time_log
CPUINFO=${HOME_DIR}/${TUMOR_SAMPLE_ID}_v_${NORMAL_SAMPLE_ID}.neoepiscope.tumor.cpu_data
